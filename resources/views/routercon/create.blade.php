      ...
      <div class="col-md-12">
        <div class="card card-success">
            <div class="card-header">
              <h3 class="card-title">Tambah Router</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('routercon.store') }}" method="post">
              @csrf
              <div class="card-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Router</label>
                  <input type="text" class="form-control" name="name" placeholder="Nama Router">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Ip-Address</label>
                  <input type="text" class="form-control" name="ip" placeholder="192.168.0.1">
                </div>
                <div class="form-group">

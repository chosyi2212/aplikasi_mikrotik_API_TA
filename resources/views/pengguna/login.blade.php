...
<head>
  ...
  <title>Login Azzahra.net</title>
  <!-- Tell the browser to be responsive to screen width -->
  <link rel="icon" type="image/jpg" sizes="16x16" href="{{ asset('template-dashboard') }}/dist/img/favicon.jpg">
    ...
    <div class="card-body login-card-body">
      ...
      <form action="{{ route('postlogin') }}" method="post">
        ...
        <div class="input-group mb-3">
          <input type="email" class="form-control" name="email" value="{{ Session::get('email') }}" placeholder="Email">
      ...
      <p class="mb-0">
        <a href="{{ route('register') }}" class="text-center">Segera daftar di sini</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>

        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="pt-4">
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        href="{{ route('dashboardpelanggan') }}" aria-expanded="false"><i class="mdi mdi-home"></i><span
                            class="hide-menu">Beranda</span></a></li>
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        href="{{ route('layananpelanggan.index') }}" aria-expanded="false"><i class="mdi mdi-speedometer"></i><span
                            class="hide-menu">Informasi Layanan</span></a></li>
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                        href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-calendar"></i><span
                            class="hide-menu">Riwayat Tagihan </span></a>
                    <ul aria-expanded="false" class="collapse  first-level ">
                        <li class="sidebar-item"><a href="{{ route('tagihanpelanggan.index') }}" class="sidebar-link"><i
                                    class="mdi mdi-square-inc-cash"></i><span class="hide-menu"> Tagihan anda
                                </span></a></li>
                        <li class="sidebar-item"><a href="{{ route('tagihanpelanggan.create') }}" class="sidebar-link"><i
                                    class="mdi mdi-plus-circle"></i><span class="hide-menu"> Konfirmasi pembayaran
                                </span></a></li>
                    </ul>
                </li>
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                        href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-clipboard-account"></i><span
                            class="hide-menu">Informasi Akun </span></a>
                    <ul aria-expanded="false" class="collapse  first-level ">
                        <li class="sidebar-item"><a href="{{ route('useraktif.index') }}" class="sidebar-link"><i
                                    class="mdi mdi-account"></i><span class="hide-menu"> Akun
                                </span></a></li>
                        <li class="sidebar-item"><a href="{{ route('useraktif.password') }}" class="sidebar-link"><i
                                    class="mdi mdi-account-key"></i><span class="hide-menu"> Ganti Password
                                </span></a></li>
                        <li class="sidebar-item"><a href="form-wizard.html" class="sidebar-link"><i
                                    class="mdi mdi-information-outline"></i><span class="hide-menu"> Tutorial Pelanggan
                                </span></a></li>
                    </ul>
                </li>
                {{-- <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"

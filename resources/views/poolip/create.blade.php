      ...
      <div class="col-md-12">
        <div class="card card-success">
            <div class="card-header">
              <h3 class="card-title">Tambah Pool</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('poolip.store') }}" method="post">
              @csrf
              <div class="card-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Pool</label>
                  <input type="text" class="form-control" name="name" placeholder="Nama Pool">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Ranges</label>
                  <input type="text" class="form-control" name="ranges" placeholder="Ranges : 192.168.10.2-192.168.10.254">
                </div>
